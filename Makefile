...
CFLAGS  = $(INCLUDES) -DDEBUG_ENABLED=0 -Wall -Wmissing-prototypes -DPRINT_ENABLED=1 -DBACAPP_ALL -DBACNET_PROPERTY_LISTS=1 -DBACDL_BIP=1 -DBBMD_ENABLED=1 -DWEAK_FUNC= -O0 -g 
